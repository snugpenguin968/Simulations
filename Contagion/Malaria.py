# Malaria epidemic simulated with the forward Euler method
#
#
...
# 
# The mosquito population remains 
...
def prevent_malaria():
    ...
    for step in range(num_steps):
        ...
        infected_humans[step + 1] = infected_humans[step]+h*(net_factor*bites_per_day_and_mosquito*infected_mosquitoes[step]*(total_humans-infected_humans[step])\
                                    /total_humans*transmission_probability_mosquito_to_human-1/human_recovery_time*infected_humans[step])
        infected_mosquitoes[step + 1] = infected_mosquitoes[step]+h*(net_factor*bites_per_day_and_mosquito*(total_mosquitoes-infected_mosquitoes[step])*infected_humans[step]\
                                    /total_humans*transmission_probability_human_to_mosquito-1/mosquito_lifetime*infected_mosquitoes[step])
