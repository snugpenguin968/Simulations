...
def seir_model():
    ...
    for step in range(num_steps):
        ...
        e[step+1]=e[step]+h*transmission_coeff*i[step]*s[step]-h/latency_time*e[step]
        i[step+1]=i[step]+h/latency_time*e[step]-h/infectious_time*i[step]
        r[step+1]=r[step]+h/infectious_time*i[step]
